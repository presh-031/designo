...
const Cta = () => {
  return (
    <div className="relative top-[18.95rem] mx-[2.4rem] mt-[-6.85rem] rounded-[1.5rem] bg-peach bg-[url('../assets/shared/desktop/bg-pattern-call-to-action.svg')] bg-right  px-[2.4rem] py-[6.4rem] text-center text-white sm:top-[8.6rem]  sm:mx-[3.9rem] sm:mt-[-1.9rem] sm:py-[5.7rem] sm:px-[8.9rem]">
