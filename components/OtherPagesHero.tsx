...
const OtherPagesHero = (props: OtherPagesHeroProps) => {
  return (
    <div className="bg-peach bg-[url('../assets/shared/desktop/bg-pattern-small-circle.svg')]   bg-[length:292px] bg-[right_top] bg-no-repeat py-[10.5rem] px-[2.4rem] text-center text-white  sm:mx-[4rem] sm:rounded-2xl sm:py-[6.4rem]">
